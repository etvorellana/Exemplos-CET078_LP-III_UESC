...
public class Main{
  public static void main(String [] args){
    ...
    // implementação do corpo da função main
		System.out.println("Implementando funções");
		System.out.println("Classse Random: As instâncias desta classe são usadas");
		...
		System.out.println("Diferente da função rand() de C, esta classe utiliza sementes diferentes a cada execução!");
		long semente;
